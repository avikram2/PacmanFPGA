...
# set_input_delay -max -clock clk_dram_ext 5.9 [get_ports {altera_reserved_tms altera_reserved_tdi}]
# set_input_delay -min -clock clk_dram_ext 3.0 [get_ports {altera_reserved_tms altera_reserved_tdi}]
